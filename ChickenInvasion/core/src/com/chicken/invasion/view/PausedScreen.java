...
public class PausedScreen extends BackgroundScreen implements IScreen {

    public PausedScreen(SpriteBatch batch, GameController controller) {
    ...
    public void render(float dt){
        ...
        controller.getBannerAt(2).draw(batch); // draw Pause banner
